...
class Student{	
	...
	public function insertAttendance($cur_date,$attend = array()){
		...
		if ($data_insert) {
			$msg = "<div class='alert alert-success'><strong>Success ! </strong> Attendace Inserted Successfully !</div>";
			return $msg;
		}else{
			$msg = "<div class='alert alert-danger'><strong>Error ! </strong> Attendace not Inserted !</div>";
			return $msg;
		}
	...
	public function updateAttendance($dt,$attend){
		...
		if ($update_result) {
			$msg = "<div class='alert alert-success'><strong>Success ! </strong> Attendace Updated Successfully !</div>";
			return $msg;
		}else{
			$msg = "<div class='alert alert-danger'><strong>Error ! </strong> Attendace not Updated !</div>";
			return $msg;
		}
	}
